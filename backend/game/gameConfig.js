...
var BUILDING_TYPES = {
  ...
  // ─── 2×2 VARIANTS (large buildings) ─────────────────────────
  farm_large: {
    name: 'Большая ферма',
    emoji: '🌾',
    description: 'Крупная ферма 2×2, производит еду в 4 раза больше',
    baseCost: { coins: 400, materials: 200 },
    baseOutput: { food: 40 },
    baseTime: 300,
    maxLevel: 50,
    category: 'production',
  ...
  quarry_large: {
    name: 'Большая каменоломня',
    emoji: '⛏️',
    description: 'Крупная каменоломня 2×2, добывает материалы в 4 раза больше',
    baseCost: { coins: 800, food: 400 },
    baseOutput: { materials: 32 },
    baseTime: 900,
    maxLevel: 50,
    category: 'production',
    unlockLevel: 4,
  ...
  factory_large: {
    ...
    emoji: '🏭',
    description: 'Крупная фабрика 2×2, конвертирует ресурсы в монеты в 4 раза больше',
    baseCost: { coins: 2000, materials: 800, food: 400 },
    baseOutput: { coins: 100 },
    baseTime: 1800,
    maxLevel: 50,
    category: 'production',
    unlockLevel: 5,
  ...
  powerplant_large: {
    name: 'Большая электростанция',
    emoji: '⚡',
    description: 'Крупная электростанция 2×2, производит энергию в 4 раза больше',
    baseCost: { coins: 3200, materials: 1200 },
    baseOutput: { energy: 20 },
    baseTime: 1200,
    maxLevel: 30,
    category: 'infrastructure',
    unlockLevel: 4,
  ...
  house_large: {
    ...
    emoji: '🏠',
    description: 'Многоквартирный дом 2×2, вмещает в 4 раза больше жителей',
    baseCost: { coins: 600, materials: 320 },
    baseOutput: { population: 20 },
    baseTime: 600,
    maxLevel: 50,
    category: 'residential',
    unlockLevel: 3,
  ...
  warehouse_large: {
    name: 'Большой склад',
    emoji: '📦',
    description: 'Большой склад 2×2, хранилище в 4 раза больше',
    baseCost: { coins: 1200, materials: 600 },
    baseOutput: { storage: 400 },
    baseTime: 0,
    maxLevel: 30,
    category: 'infrastructure',
    unlockLevel: 4,
  ...
  market_large: {
    name: 'Большой рынок',
    emoji: '🏪',
    description: 'Большой рынок 2×2, пассивный доход в 4 раза больше',
    baseCost: { coins: 1600, materials: 400, food: 200 },
    baseOutput: { coins: 20 },
    baseTime: 600,
    maxLevel: 40,
    category: 'commercial',
  ...
  windmill_large: {
    name: 'Ветропарк',
    emoji: '💨',
    description: 'Ветропарк 2×2, вырабатывает энергию в 4 раза больше',
    baseCost: { coins: 9600, materials: 3600 },
    baseOutput: { energy: 40 },
    baseTime: 1800,
    maxLevel: 30,
    category: 'infrastructure',
    unlockLevel: 6,
  ...
  bank_large: {
    ...
    emoji: '🏦',
    description: 'Финансовый центр 2×2, огромный доход монет',
    baseCost: { coins: 8000, materials: 2000 },
    baseOutput: { coins: 200 },
    baseTime: 3600,
    maxLevel: 25,
    category: 'commercial',
    unlockLevel: 10,
  ...
  hospital_large: {
    ...
    emoji: '🏥',
    description: 'Медицинский центр 2×2, максимальный прирост населения',
    baseCost: { coins: 4000, materials: 1600, food: 800 },
    baseOutput: { population: 40 },
    baseTime: 1200,
    maxLevel: 20,
    category: 'special',
    unlockLevel: 8,
  ...
  stadium_large: {
    name: 'Мегастадион',
    emoji: '🏟️',
    description: 'Мегастадион 2×2, огромное население и монеты',
    baseCost: { coins: 20000, materials: 4000, food: 2000 },
    baseOutput: { population: 80, coins: 120 },
    baseTime: 3600,
    maxLevel: 15,
    category: 'special',
    unlockLevel: 15,
  ...
  // ─── DECORATIVE 2×2 BUILDINGS ───────────────────────────────
  townhall: {
    name: 'Ратуша',
    emoji: '🏛️',
    description: 'Величественная ратуша. Украшает город, даёт опыт и монеты',
    baseCost: { coins: 5000, materials: 2000 },
    baseOutput: { experience: 30, coins: 20 },
    baseTime: 1800,
    maxLevel: 20,
    category: 'decoration',
    unlockLevel: 6,
  ...
  church: {
    name: 'Церковь',
    emoji: '⛪',
    description: 'Красивая церковь. Даёт опыт и монеты',
    baseCost: { coins: 4000, materials: 1500 },
    baseOutput: { experience: 25, coins: 15 },
    baseTime: 1500,
    maxLevel: 20,
    category: 'decoration',
    unlockLevel: 5,
  ...
  firestation: {
    ...
    emoji: '🚒',
    description: 'Пожарная станция. Даёт опыт и увеличивает население',
    baseCost: { coins: 4500, materials: 1800 },
    baseOutput: { experience: 20, population: 8 },
    baseTime: 1200,
    maxLevel: 20,
    category: 'decoration',
    unlockLevel: 5,
  ...
  centralpark: {
    ...
    emoji: '🌳',
    description: 'Огромный парк 4×4. Резко увеличивает население и даёт опыт',
    baseCost: { coins: 15000, materials: 5000 },
    baseOutput: { experience: 50, population: 30 },
    baseTime: 3600,
    maxLevel: 10,
    category: 'decoration',
    unlockLevel: 10,
  ...
  beachlake: {
    name: 'Озеро с пляжем',
    emoji: '🏖️',
    description: 'Красивое озеро с пляжем 2×2. Даёт опыт и монеты',
    baseCost: { coins: 6000, materials: 2500 },
    baseOutput: { experience: 20, coins: 25 },
    baseTime: 1800,
    maxLevel: 15,
    category: 'decoration',
    unlockLevel: 7,
  ...
  // ─── PREMIUM BUILDINGS (50k each) ────────────────────────────
  cardealer: {
    name: 'Автосалон',
    emoji: '🚗',
    description: 'Роскошный автосалон 2×2. Пассивный доход 1000 монет/час',
    baseCost: { coins: 50000, materials: 50000 },
    baseOutput: { coins: 1000 },
    baseTime: 3600,
    maxLevel: 10,
    category: 'commercial',
    unlockLevel: 15,
  ...
  military: {
    name: 'Армия',
    emoji: '⚔️',
    description: 'Военная база 2×2. Привлекает +150 человек населения',
    baseCost: { coins: 50000, materials: 50000 },
    baseOutput: { population: 150, experience: 10 },
    baseTime: 3600,
    maxLevel: 10,
    category: 'special',
    unlockLevel: 15,
  ...
  police: {
    name: 'Полиция',
    emoji: '🚔',
    description: 'Полицейское управление 2×2. Обеспечивает порядок, +150 человек',
    baseCost: { coins: 50000, materials: 50000 },
    baseOutput: { population: 150, experience: 10 },
    baseTime: 3600,
    maxLevel: 10,
  ...
  nuclearplant: {
    ...
    emoji: '☢️',
    description: 'Мощнейшая электростанция 4×4. Вырабатывает 200 единиц энергии!',
    baseCost: { coins: 60000, materials: 50000 },
    baseOutput: { energy: 200 },
    baseTime: 7200,
    maxLevel: 5,
    category: 'infrastructure',
    unlockLevel: 18,
...
var QUEST_TEMPLATES = [
  ...
  { id: 's42', type: 'build', target: 'farm_large', count: 1, reward: { coins: 1000, materials: 500 }, minLevel: 3, description: 'Построй большую ферму 2×2' },
  { id: 's43', type: 'build', target: 'house_large', count: 1, reward: { coins: 1000, food: 300 }, minLevel: 3, description: 'Построй многоквартирный дом 2×2' },
  { id: 's44', type: 'build', target: 'windmill_large', count: 1, reward: { coins: 3000, crystals: 10 }, minLevel: 6, description: 'Построй ветропарк 2×2' },
  { id: 's45', type: 'build', target: 'townhall', count: 1, reward: { coins: 5000, crystals: 15 }, minLevel: 6, description: 'Построй ратушу' },
  { id: 's46', type: 'build', target: 'church', count: 1, reward: { coins: 3000, crystals: 10 }, minLevel: 5, description: 'Построй церковь' },
  { id: 's47', type: 'build', target: 'firestation', count: 1, reward: { coins: 3000, crystals: 10 }, minLevel: 5, description: 'Построй пожарную станцию' },
  { id: 's48', type: 'build', target: 'beachlake', count: 1, reward: { coins: 5000, crystals: 15 }, minLevel: 7, description: 'Построй озеро с пляжем' },
  { id: 's49', type: 'build', target: 'centralpark', count: 1, reward: { coins: 15000, crystals: 25 }, minLevel: 10, description: 'Построй центральный парк 4×4' },
  { id: 's50', type: 'build', target: 'cardealer', count: 1, reward: { coins: 10000, crystals: 30 }, minLevel: 15, description: 'Построй автосалон' },
  { id: 's51', type: 'build', target: 'military', count: 1, reward: { coins: 10000, crystals: 30 }, minLevel: 15, description: 'Создай армию' },
  { id: 's52', type: 'build', target: 'police', count: 1, reward: { coins: 10000, crystals: 30 }, minLevel: 15, description: 'Построй полицию' },
  { id: 's53', type: 'build', target: 'nuclearplant', count: 1, reward: { coins: 20000, crystals: 50 }, minLevel: 18, description: 'Построй атомную электростанцию' },
  { id: 's54', type: 'reach_population', target: 'population', count: 500, reward: { coins: 30000, crystals: 40 }, minLevel: 20, description: 'Достигни 500 населения' },
  { id: 's55', type: 'build', target: 'bank_large', count: 1, reward: { coins: 5000, crystals: 15 }, minLevel: 10, description: 'Построй финансовый центр 2×2' }
];
...
var RANDOM_QUEST_POOLS = {
  build: [
    ...
    { target: 'farm_large', desc: 'Построй большую ферму', base_reward: 800 },
    { target: 'house_large', desc: 'Построй многоквартирный дом', base_reward: 800 },
    { target: 'windmill_large', desc: 'Построй ветропарк', base_reward: 2000 },
    { target: 'townhall', desc: 'Построй ратушу', base_reward: 3000 },
    { target: 'church', desc: 'Построй церковь', base_reward: 2000 },
    { target: 'firestation', desc: 'Построй пожарную станцию', base_reward: 2000 },
    { target: 'beachlake', desc: 'Построй озеро с пляжем', base_reward: 3000 },
    { target: 'cardealer', desc: 'Построй автосалон', base_reward: 10000 },
    { target: 'military', desc: 'Создай армию', base_reward: 10000 },
    { target: 'police', desc: 'Построй полицию', base_reward: 10000 }
  ],
  collect: [
